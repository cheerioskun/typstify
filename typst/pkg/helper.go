...
func CreatePkg(pkgDir string, name string, isTemplate bool, author string) (string, error) {
	if name == "" {
...
func createTemplateDocument(packageDir string, name string, author string) (string, error) {
	if packageDir == "" {
