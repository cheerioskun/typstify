...
func (m *Menu) SetOptions(options [][]MenuOption) {
	m.focusedOption = -1
	m.optionStates = m.optionStates[:0]
	m.requestDismiss = false
	m.options = options
	m.optionsUpdated = true
}

func (m *Menu) buildMenus(th *theme.Theme, options [][]MenuOption) {
	if !m.optionsUpdated {
		return
	}
...
func (m *Menu) precomputeWidth(gtx C, th *theme.Theme) int {
